 ...
 */
#if (defined(__STDC__) | defined(__cplusplus) | defined(DB2OS2) | defined(DB2NT))
#ifdef __cplusplus
extern "C" {
#endif
 #ifndef DB2NT
  extern int SQL_API_FN ax_reg(int, XID *, long);
  extern int SQL_API_FN ax_unreg(int, long);
...
struct xa_switch_t {
  ...
  int (PSQL_API_FN xa_start_entry) (XID *, int, long);/* xa_start function pointer */
  int (PSQL_API_FN xa_end_entry) (XID *, int, long);/* xa_end function pointer */
  int (PSQL_API_FN xa_rollback_entry) (XID *, int, long);/* xa_rollback function pointer */
  int (PSQL_API_FN xa_prepare_entry) (XID *, int, long);/* xa_prepare function pointer */
  int (PSQL_API_FN xa_commit_entry) (XID *, int, long);/* xa_commit function pointer */
  int (PSQL_API_FN xa_recover_entry) (XID *, long, int, long);
                                       /* xa_recover function pointer*/
  int (PSQL_API_FN xa_forget_entry) (XID *, int, long);/* xa_forget function pointer */
