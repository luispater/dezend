...
typedef ULONG ( *INIT_FUNCTION )( PVOID Element, PVOID Context );
typedef ULONG ( *UNINIT_FUNCTION )( PVOID Element, PVOID Context );
typedef LONG ( *COMPARE_FUNCTION )( PVOID Element1, PVOID Element2 );
...
typedef struct _COMMON_STACK_T {
    ...
    ULONG Size;
    INIT_FUNCTION Init;
    UNINIT_FUNCTION Uninit;
    COMPARE_FUNCTION SortCompare;
    COMPARE_FUNCTION FindCompare;
    PVOID Context;
...
/* Object */
ULONG StackInitT( PCOMMON_STACK_T Stack, ULONG Max, ULONG Size, INIT_FUNCTION, UNINIT_FUNCTION, COMPARE_FUNCTION SortCompare, COMPARE_FUNCTION FindCompare, PVOID Context );
...
void StackSetSortCompareT( PCOMMON_STACK_T Stack, COMPARE_FUNCTION );
void StackSetFindCompareT( PCOMMON_STACK_T Stack, COMPARE_FUNCTION );
